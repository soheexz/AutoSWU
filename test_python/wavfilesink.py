...
class wavfilesink(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "wavfilesink")
        ...
        self.osmosdr_source_0.set_center_freq(2.400e9, 0)
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink('/home/pi/WNIC/wav2csv/wavfile/t1.wav', 1, 32000, 8)
...
def main(top_block_cls=wavfilesink, options=None):
